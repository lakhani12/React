      ...
      <section className="flex items-end justify-center w-full">
        ...
        <div className="w-1/2 overflow-hidden px-6">
          ...
          <p className="my-2 text-[18px] font-normal">
            ...
            {/* Search Bar */}
            <div className="bg-gray-200 px-4 py-3 flex items-center justify-between gap-x-2 rounded-full w-[75%]">
        ...
        <div className="w-1/2 border border-[#0000001f] rounded-lg px-4 py-6 flex items-center justify-evenly max-w-xl">
          ...
          <div className="w-1/2 relative">
            ...
            {/* chip 2 */}
            <div className="flex items-center justify-center gap-x-4 absolute z-10 text-[12px] bg-white border border-gray-200 px-2 py-1 rounded-full top-44 -left-6">
              <CircleCheck fill="green" className="text-white w-5 h-5" />
