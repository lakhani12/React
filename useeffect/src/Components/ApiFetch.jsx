...
const ApiFetch = () => {
  ...
  // Method 3
  let Method3 = async() => {
    let reponse = await axios.get("https://dummyjson.com/recipes?limit10")
    ...
    <>
      ...
      <section className="w-full h-screen flex flex-col items-center justify-center gap-y-4 p-6  bg-blue-100">
        ...
        <div className="bg-black p-4 w-full rounded-md overflow-auto h-144 ">
          {Data2.map((pro,id)=>{
            return(
              <div key={id}>
                <div className="card w-full h-auto max-w-sm bg-gray-950 rounded-[10%] p-2 text-white shadow-2xl gap-10">
        ...
        <button className="w-36 px-4 py-2 text-center text-white bg-blue-950 rounded-md font-bold text-xl active:bg-blue-500 active:text-blue-950 active:scale-95 transition-all" onClick={Method2}>
          Get Data 2
        </button>
      </section>
      ...
      <section className="w-full h-screen flex flex-col items-center justify-center gap-y-4 p-6  bg-orange-100">
        ...
        <div className="bg-black p-4 w-full rounded-md overflow-auto h-144 text-white flex flex-wrap items-center justify-center gap-4">
          {Data3.map((rec,id)=>{
            return(
              <div key={id} className="bg-[#555] w-64 P-2 ">
                <img src={rec.image} alt="img" className="rounded-xl" />
                <div className="text-center bg-[#222] my-1 rounded-b-xl">
                  <h1>{rec.name}</h1>
        ...
        <button className="w-36 px-4 py-2 text-center text-white bg-orange-950 rounded-md font-bold text-xl active:bg-orange-500 active:text-orange-950 active:scale-95 transition-all" onClick={Method3}>
          Get Data 3
        </button>
      </section>
    </>
