...
const AddUser = () => {
  const [Data, setData] = useState([
    { name: "Aarav Patel", email: "aarav@gmail.com", color: "bg-green-400" },
    { name: "Riya Sharma", email: "riya@gmail.com", color: "bg-orange-400" },
    { name: "Vivan Maheta", email: "vivan@gmail.com", color: "bg-yellow-400" },
  ]);
  ...
  function Add() {
    ...
    if (Data[3]?.name === "Ananaya Gupta") return alert("User Already Exists!");
  ...
  function AddTwo() {
    ...
    if (Data[4]?.name === "Aditya Nair" || Data[5]?.name === "Sneha Kapoor") return alert("User Already Exists!");
